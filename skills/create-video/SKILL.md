...
4. If the user wants edits (trimming, captions, filler word removal, etc.), use `prompt_project_agent` to edit with Underlord, Descript's AI co-editor, passing the new project's ID and a natural language description of the edits.

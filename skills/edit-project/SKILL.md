---
name: edit-project
description: Edit an existing Descript project with Underlord, Descript's AI co-editor, using natural language instructions.
---
...
- When applying Underlord edits like trimming, captioning, or rearranging
